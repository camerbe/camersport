...
export class FormationPositionService {
  ...
  formations: Formation[] = [
    ...
    // Formation 3-5-2
    {
      ...
      positions: [
        { label: "Gardien", value: "GK", x: 5, y: 50 },
        { label: "Défenseur central", value: "CB", x: 20, y: 20 },
        { label: "Défenseur droit", value: "RB", x: 50, y: 20 },
        { label: "Défenseur gauche", value: "LB", x: 20, y: 80 },
    ...
    // Formation 5-3-2 Défensif
    {
      ...
      positions: [
        { label: "Gardien", value: "GK", x: 5, y: 50 },
        { label: "Défenseur droit", value: "RB", x: 20, y: 85 },
        { label: "Défenseur central", value: "CB1", x: 20, y: 50 },
        { label: "Défenseur central", value: "CB2", x: 15, y: 30 },
        { label: "Défenseur central", value: "CB3", x: 15, y: 65 },
        { label: "Défenseur gauche", value: "LB", x: 20, y: 15 },
        { label: "Milieu défensif", value: "CDM", x: 35, y: 25 },
        { label: "Milieu central", value: "CM1", x: 35, y: 50 },
        { label: "Milieu central", value: "CM2", x: 35, y: 70 },
        { label: "Attaquant", value: "ST1", x: 45, y: 20 },
        { label: "Attaquant", value: "ST2", x: 45, y: 80 },
      ],
    },
  ];
